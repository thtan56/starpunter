  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-2">
      <section class="list">
        ...
        <draggable class="drag-area" :list="tasksNotCompletedNew" 
                  :options="{animation:200, group:'status'}" :element="'article'" 
                  @add="onAdd($event, false)"  @change="update">    
          <article class="card" v-for="(task, index) in tasksNotCompletedNew" 
                    :key="task.id" :data-id="task.id">
...
//    gamelist,
  ...
  data () {
    return {
      tasksCompleted:   [{name:"Juan", id:1},  {name:"Edgard", id:2},  {name:"Johnson", id:3} ],
      tasksNotCompleted:[{name:"Juan2", id:11},{name:"Edgard2", id:12},{name:"Johnson2", id:13} ],
      organiser: 'NBA',  
    }
  },
  methods:{
