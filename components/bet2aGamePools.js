...
`,
    data () {
      return {
        ...
        search: '',
        tabs: null,
        tabItems: ['Head2Head', 'Group', 'Result'],
    ...
    methods: {
      ...
      deleteItem: function(item){
        ...
        if(r==true) {
          ...
          this.$http.post('php/apiPoolGamesGames.php', JSON.stringify(postdata),{ headers: { 'Content-Type': 'application/json' }})
      ...
      save() {
        ...
        this.$http.post('php/apiPoolGamesGames.php', postdata,{ headers: { 'Content-Type': 'application/json' } })
          .then(response => {
  ...
  //    Object.assign(this.pools[this.editedIndex], this.editedItem);
      ...
      getBetPools: function (game) {
        ...
        this.$http.post('php/apiPoolGamesGames.php', JSON.stringify(postdata), {
          headers: { 'Content-Type': 'application/json' }
